...
var rootCmd = &cobra.Command{
	Use:   "templatefactory",
	Short: "A tool to create templates out of your directories/files and use them later!",
	Long:  `A tool to create templates out of your directories/files and use them later!`,
